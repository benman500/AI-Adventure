...
- Cultivation uses locked early major realms: **Body Tempering**, **Qi Gathering**, **Foundation Establishment**, **Core Formation**, plus component systems **Body**, **Qi**, **Soul**, **Dao**, and **Foundation Quality** ([CULTIVATION_SYSTEM.md](CULTIVATION_SYSTEM.md), [REALMS.md](REALMS.md)).
